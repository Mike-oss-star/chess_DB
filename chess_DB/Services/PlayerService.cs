...
// Chemin relatif vers le fichier JSON
    ...
    public PlayerService()
    {
        ...
        _cheminFichier = Path.Combine(repertoireProjet, "Data", "player.json");
    ...
    public async Task<List<Player>> ObtenirTousLesJoueursAsync()
    {
        try
        {
            ...
            var joueurs = JsonSerializer.Deserialize<List<Player>>(jsonContenu, _jsonOptions);
            
            // Retourner la liste (ou une liste vide si null)
            return joueurs ?? new List<Player>();
        }
        catch (Exception ex)
        {
    ...
    public async Task<bool> AjouterJoueurAsync(Player joueur)
    {
        try
        {
    ...
    public async Task<Player?> ObtenirJoueurParIdAsync(Guid id)
    {
        var joueurs = await ObtenirTousLesJoueursAsync();
    ...
    public async Task<bool> ModifierJoueurAsync(Player joueur)
    {
        try
        {
            var joueurs = await ObtenirTousLesJoueursAsync();
